...
- [ ] **Task 2 — `IngressoService`: `listarMinhas()` e `buscarPublico()` com validação HMAC antes do banco (AC1-5)**
  ...
  - [ ] Commit: `feat(ingressos): IngressoService.listarMinhas()/buscarPublico() (AC1-5)`
