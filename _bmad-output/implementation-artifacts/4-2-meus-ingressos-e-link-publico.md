...
- [ ] [Review][Patch] `ORDER BY s.dataHora DESC` sem desempate — ordem de ingressos com o mesmo `dataHora` de sessão pode variar entre chamadas [api/src/main/java/br/com/rolo35/api/ingressos/repository/IngressoRepository.java:28]
