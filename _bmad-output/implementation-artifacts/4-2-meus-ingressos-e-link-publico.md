...
- [ ] [Review][Patch] `IngressoSecurityTest` cobre `CLIENTE`/sem token/`ORGANIZADOR` pra `/minhas`, mas nunca testa o papel `PORTARIA` — terceiro papel real do domínio, sem cobertura nesta rota [api/src/test/java/br/com/rolo35/api/ingressos/IngressoSecurityTest.java]
