...
- [ ] [Review][Patch] Nome de teste mistura inglês/português (`buscarPublicoReturns200WithoutTokenNenhum`) — resto do arquivo é consistente, esse parece resíduo de edição [api/src/test/java/br/com/rolo35/api/ingressos/IngressoSecurityTest.java]
