...
- [Source: instruções do projeto — Metodologia XP + TDD, evitar N+1, sem regra de negócio no controller, estados de carregando/lista vazia/erro, Convenções de nomenclatura]
