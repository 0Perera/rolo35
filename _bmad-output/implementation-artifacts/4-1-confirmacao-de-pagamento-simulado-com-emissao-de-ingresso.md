...
- [ ] **Task 3 — `PagamentoService.confirmar()`: lock pessimista + write path idempotente (AC1-5)**
  ...
  - [ ] Commit: `feat(pagamentos): PagamentoService.confirmar() com lock pessimista e idempotência (AC1-5)`
