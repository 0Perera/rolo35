...
- [ ] [Review][Patch] `CodigoIngressoService` não valida secret vazio/curto no construtor — um `TICKET_HMAC_SECRET` em branco constrói a chave silenciosamente em vez de falhar rápido no boot [api/src/main/java/br/com/rolo35/api/ingressos/service/CodigoIngressoService.java:21-22]
