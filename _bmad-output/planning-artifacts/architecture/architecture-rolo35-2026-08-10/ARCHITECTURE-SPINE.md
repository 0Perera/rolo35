...
- **Rate limiting em endpoints públicos** (busca de sessões, link de ingresso, mapa de assentos). Não é non-negotiable do PRD; fica de fora do V1 por decisão deliberada dado o prazo de 7 dias.
